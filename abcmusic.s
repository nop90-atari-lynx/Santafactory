...
_abcactive:			; Read only active flags for 4 channels
	.byte 0,0,0,0
abc_repeat_addr0:		; Something to do with repeat of sections
	.byte 0,0
abc_repeat_addr1:
	.byte 0,0
abc_repeat_addr2:
...
startrepeat:
	...
	bne @L1
		ldy _abc_score_ptr0
		sty abc_repeat_addr0
		ldy _abc_score_ptr0+1
		sty abc_repeat_addr0+1
		bra @L4
@L1:
	dea
	bne @L2
		ldy _abc_score_ptr1
		sty abc_repeat_addr1
		ldy _abc_score_ptr1+1
		sty abc_repeat_addr1+1
		bra @L4
@L2:
	dea
	bne @L3
		ldy _abc_score_ptr2
		sty abc_repeat_addr2
		ldy _abc_score_ptr2+1
		sty abc_repeat_addr2+1
		bra @L4
@L3:
		ldy _abc_score_ptr3
		sty abc_repeat_addr3
		ldy _abc_score_ptr3+1
		sty abc_repeat_addr3+1
@L4:
	rts
...
endrepeat:
	...
	dea
	bne @L5
		ldy abc_repeat_addr0
		sty _abc_score_ptr0
		ldy abc_repeat_addr0+1
		sty _abc_score_ptr0+1
		bra @L8
@L5:
	dea
	bne @L6
		ldy abc_repeat_addr1
		sty _abc_score_ptr1
		ldy abc_repeat_addr1+1
		sty _abc_score_ptr1+1
		bra @L8
@L6:
	dea
	bne @L7
		ldy abc_repeat_addr2
		sty _abc_score_ptr2
		ldy abc_repeat_addr2+1
		sty _abc_score_ptr2+1
		bra @L8
@L7:
		ldy abc_repeat_addr3
		sty _abc_score_ptr3
		ldy abc_repeat_addr3+1
		sty _abc_score_ptr3+1
@L8:
	rts
...
;		cmp #0		
		bne @L4
		lda _abc_score_ptr0+1
		ina
		sta _abc_score_ptr0+1
		bra @L4
@L1:
	dea
	bne @L2
		...
		sta _abc_score_ptr1
		bne @L4
		lda _abc_score_ptr1+1
		ina
		sta _abc_score_ptr1+1
		bra @L4
@L2:
	dea
	bne @L3
		...
		sta _abc_score_ptr2
		bne @L4
		lda _abc_score_ptr2+1
		ina
		sta _abc_score_ptr2+1
		bra @L4
@L3:
		lda _abc_score_ptr3
		ina
		sta _abc_score_ptr3
		bne @L4
		lda _abc_score_ptr3+1
		ina
		sta _abc_score_ptr3+1
@L4:
	tya
end_read_char:
	rts
